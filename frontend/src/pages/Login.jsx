...
import { LogIn, Loader2, KeyRound, User as UserIcon, Brain } from 'lucide-react';
            ...
            >
                ...
                <div className="relative">
                    <div className="mb-14 text-center">
                        ...
                        <h2 className="text-5xl font-black text-white mb-4 italic tracking-tighter">Neural <span className="text-primary not-italic">Evaluation</span></h2>
                        <p className="text-zinc-500 font-medium text-lg uppercase tracking-[0.2em] text-xs">Luminary Recruitment Engine</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em] ml-2">Username</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em] ml-2">Pass-Key</label>
                            <div className="relative group/input">
                        ...
                        >
                            ...
                            {isSubmitting ? (
                                ...
                                <>
                                    Establish Link
                                    <div className="group-hover/btn:translate-x-2 transition-transform duration-500">→</div>
                                </>
                            )}
                        </button>
                    </form>
                    ...
                    <div className="mt-12 text-center space-y-4">
                        <p className="text-zinc-600 font-bold text-xs uppercase tracking-widest">
                            New Subject? <Link to="/register" className="text-primary hover:text-white transition-colors font-black">Register Profile</Link>
                        </p>
                    </div>
                </div>
            </motion.div>
